...
public sealed class HostLifecycleProcessTests
{
    ...
    public async Task SecondHostIsRejectedAndOrphanedDescriptorDoesNotBlockRestart()
    {
        ...
        try
        {
            ...
            replacementHost = StartHost(runtimeBase, stateBase);
